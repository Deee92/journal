Category | Generator (.rb) | Data (.yml) | verdict
-------- | --------------- | ----------- | -------
blockchain | aeternity.rb | x | 
blockchain | bitcoin.rb | x
blockchain | ethereum.rb | x
blockchain | tezos.rb | x
books | book.rb | book.yml | 
books | culture_series.rb | culture_series.yml | uncoventional
books | dune.rb | dune.yml | uncoventional
books | lovecraft.rb | lovecraft.yml | uncoventional
books | the_kingkiller_chronicle.rb | the_kingkiller_chronicle.yml | uncoventional
creature | animal.rb | animal.yml
creature | bird.rb | bird.yml  | uncoventional
creature | cat.rb | cat.yml | uncoventional
creature | dog.rb | dog.yml | uncoventional
creature | horse.rb | horse.yml | uncoventional
default | address.rb | address.yml
default | adjective.rb | adjective.yml
default | alphanumeric.rb | x
default | ancient.rb | ancient.yml | uncoventional
default | app.rb | app.yml
default | appliance.rb | appliance.yml
default | artist.rb | artist.yml | uncoventional
default | avatar.rb | x
default | bank.rb | bank.yml
default | barcode.rb | barcode.yml
default | beer.rb | beer.yml
default | blood.rb | blood.yml
default | boolean.rb | x
default | bossa_nova.rb | bossa_nova.yml | uncoventional
default | business.rb | business.yml
default | camera.rb | camera.yml
default | cannabis.rb | cannabis.yml | uncoventional
default | chile_rut.rb | x
default | chuck_norris.rb | chuck_norris.yml | uncoventional
default | code.rb | code.yml
default | coffee.rb | coffee.yml | uncoventional
default | coin.rb | coin.yml
default | color.rb | color.yml
default | commerce.rb | commerce.yml
default | company.rb | company.yml
default | compass.rb | compass.yml
default | computer.rb | computer.yml
default | construction.rb | construction.yml
default | cosmere.rb | cosmere.yml | uncoventional
default | crypto.rb | x
default | crypto_coin.rb | crypto_coin.yml
default | currency.rb | currency.yml
default | date.rb | x
default | dc_comics.rb | dc_comics.yml | uncoventional
default | demographic.rb | demographic.yml
default | dessert.rb | dessert.yml
default | device.rb | device.yml
default | driving_license.rb | driving_license.yml
default | drone.rb | drone.yml | uncoventional
default | educator.rb | educator.yml
default | electrical_components.rb | electrical_components.yml
default | emotion.rb | emotion.yml
default | esport.rb | esport.yml | uncoventional
default | file.rb | file.yml
default | finance.rb | finance.yml
default | food.rb | food.yml
default | funny_name.rb | funny_name.yml | uncoventional
default | gender.rb | gender.yml
default | greek_philosophers.rb | greek_philosophers.yml | uncoventional
...
games | league_of_legends.rb | league_of_legends.yml | uncoventional
...
sports | volleyball.rb | volleyball.yml | uncoventional
