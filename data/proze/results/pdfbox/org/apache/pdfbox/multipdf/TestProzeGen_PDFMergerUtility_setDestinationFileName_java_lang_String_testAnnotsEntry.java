 ...
 */
public class TestProzeGen_PDFMergerUtility_setDestinationFileName_java_lang_String_testAnnotsEntry {
    ...
    public static void setUp() {
        TestProzeGen_PDFMergerUtility_setDestinationFileName_java_lang_String_testAnnotsEntry.OUT_DIR.mkdirs();
    }
    ...
    public void testAnnotsEntry(String param0) throws java.io.IOException {
        ...
        try {
            java.io.File f1 = new java.io.File(TestProzeGen_PDFMergerUtility_setDestinationFileName_java_lang_String_testAnnotsEntry.TARGET_PDF_DIR, "PDFBOX-1031-1.pdf");
            s1 = new java.io.FileInputStream(f1);
            java.io.File f2 = new java.io.File(TestProzeGen_PDFMergerUtility_setDestinationFileName_java_lang_String_testAnnotsEntry.TARGET_PDF_DIR, "PDFBOX-1031-2.pdf");
            s2 = new java.io.FileInputStream(f2);
            java.io.File pdfOutput = new java.io.File(TestProzeGen_PDFMergerUtility_setDestinationFileName_java_lang_String_testAnnotsEntry.OUT_DIR, "PDFBOX-1031.pdf");
