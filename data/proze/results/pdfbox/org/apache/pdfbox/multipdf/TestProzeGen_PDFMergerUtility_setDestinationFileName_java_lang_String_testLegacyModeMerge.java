 ...
 */
public class TestProzeGen_PDFMergerUtility_setDestinationFileName_java_lang_String_testLegacyModeMerge {
    ...
    public static void setUp() {
        TestProzeGen_PDFMergerUtility_setDestinationFileName_java_lang_String_testLegacyModeMerge.OUT_DIR.mkdirs();
    }
    ...
    public void testLegacyModeMerge(String param0) throws java.io.IOException {
        ...
        java.io.File toBeMerged = new java.io.File(TestProzeGen_PDFMergerUtility_setDestinationFileName_java_lang_String_testLegacyModeMerge.IN_DIR, "AcroFormForMerge.pdf");
        java.io.File pdfOutput = new java.io.File(TestProzeGen_PDFMergerUtility_setDestinationFileName_java_lang_String_testLegacyModeMerge.OUT_DIR, "PDFBoxLegacyMerge-SameMerged.pdf");
        ...
        try {
            compliantDocument = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File(TestProzeGen_PDFMergerUtility_setDestinationFileName_java_lang_String_testLegacyModeMerge.IN_DIR, "PDFBoxLegacyMerge-SameMerged.pdf"));
            toBeCompared = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File(TestProzeGen_PDFMergerUtility_setDestinationFileName_java_lang_String_testLegacyModeMerge.OUT_DIR, "PDFBoxLegacyMerge-SameMerged.pdf"));
    ...
    private void compareFieldProperties(org.apache.pdfbox.pdmodel.interactive.form.PDField sourceField, org.apache.pdfbox.pdmodel.interactive.form.PDField toBeComapredField) {
        ...
        for (String key : keys) {
            ...
            if (sourceBase != null) {
                assertEquals(sourceBase.toString(), toBeComparedBase.toString(), "The content of the field properties shall be the same");
            } else {
