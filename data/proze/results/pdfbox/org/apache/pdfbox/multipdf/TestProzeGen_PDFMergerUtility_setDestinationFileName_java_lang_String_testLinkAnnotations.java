 ...
 */
public class TestProzeGen_PDFMergerUtility_setDestinationFileName_java_lang_String_testLinkAnnotations {
    ...
    public static void setUp() {
        TestProzeGen_PDFMergerUtility_setDestinationFileName_java_lang_String_testLinkAnnotations.OUT_DIR.mkdirs();
    }
    ...
    public void testLinkAnnotations(String param0) throws java.io.IOException {
        ...
        try {
            java.io.File file1 = new java.io.File(TestProzeGen_PDFMergerUtility_setDestinationFileName_java_lang_String_testLinkAnnotations.TARGET_PDF_DIR, "PDFBOX-1065-1.pdf");
            is1 = new java.io.FileInputStream(file1);
            java.io.File file2 = new java.io.File(TestProzeGen_PDFMergerUtility_setDestinationFileName_java_lang_String_testLinkAnnotations.TARGET_PDF_DIR, "PDFBOX-1065-2.pdf");
            is2 = new java.io.FileInputStream(file2);
            java.io.File pdfOutput = new java.io.File(TestProzeGen_PDFMergerUtility_setDestinationFileName_java_lang_String_testLinkAnnotations.OUT_DIR, "PDFBOX-1065.pdf");
