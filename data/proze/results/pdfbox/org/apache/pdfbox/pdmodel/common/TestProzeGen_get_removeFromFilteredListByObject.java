...
public class TestProzeGen_get_removeFromFilteredListByObject {
//    @org.junit.Rule
//    public org.junit.rules.ExpectedException thrown = org.junit.rules.ExpectedException.none();
    ...
    public static void setUp() throws Exception {
        TestProzeGen_get_removeFromFilteredListByObject.annotationsList = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>();
        ...
        TestProzeGen_get_removeFromFilteredListByObject.annotationsList.add(txtMark);
        TestProzeGen_get_removeFromFilteredListByObject.annotationsList.add(txtLink);
        TestProzeGen_get_removeFromFilteredListByObject.annotationsList.add(aCircle);
        TestProzeGen_get_removeFromFilteredListByObject.annotationsList.add(txtLink);
        assertEquals(4, TestProzeGen_get_removeFromFilteredListByObject.annotationsList.size());
        TestProzeGen_get_removeFromFilteredListByObject.tbcAnnotationsList = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>();
        TestProzeGen_get_removeFromFilteredListByObject.tbcAnnotationsList.add(txtMark);
        TestProzeGen_get_removeFromFilteredListByObject.tbcAnnotationsList.add(txtLink);
        TestProzeGen_get_removeFromFilteredListByObject.tbcAnnotationsList.add(aCircle);
        TestProzeGen_get_removeFromFilteredListByObject.tbcAnnotationsList.add(txtLink);
        assertEquals(4, TestProzeGen_get_removeFromFilteredListByObject.tbcAnnotationsList.size());
        TestProzeGen_get_removeFromFilteredListByObject.annotationsArray = new org.apache.pdfbox.cos.COSArray();
        TestProzeGen_get_removeFromFilteredListByObject.annotationsArray.add(txtMark);
        TestProzeGen_get_removeFromFilteredListByObject.annotationsArray.add(txtLink);
        TestProzeGen_get_removeFromFilteredListByObject.annotationsArray.add(aCircle);
        TestProzeGen_get_removeFromFilteredListByObject.annotationsArray.add(txtLink);
        assertEquals(4, TestProzeGen_get_removeFromFilteredListByObject.annotationsArray.size());
        TestProzeGen_get_removeFromFilteredListByObject.tbcAnnotationsArray = new org.apache.pdfbox.cos.COSBase[4];
        TestProzeGen_get_removeFromFilteredListByObject.tbcAnnotationsArray[0] = txtMark.getCOSObject();
        TestProzeGen_get_removeFromFilteredListByObject.tbcAnnotationsArray[1] = txtLink.getCOSObject();
        TestProzeGen_get_removeFromFilteredListByObject.tbcAnnotationsArray[2] = aCircle.getCOSObject();
        TestProzeGen_get_removeFromFilteredListByObject.tbcAnnotationsArray[3] = txtLink.getCOSObject();
        assertEquals(4, TestProzeGen_get_removeFromFilteredListByObject.tbcAnnotationsArray.length);
        // add the annotations to the page
        TestProzeGen_get_removeFromFilteredListByObject.pdPage = new org.apache.pdfbox.pdmodel.PDPage();
        TestProzeGen_get_removeFromFilteredListByObject.pdPage.setAnnotations(TestProzeGen_get_removeFromFilteredListByObject.annotationsList);
        // create test output directory
        TestProzeGen_get_removeFromFilteredListByObject.OUT_DIR.mkdirs();
    }
...
//        thrown.expect(UnsupportedOperationException.class);
        ...
        COSArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation> cosArrayList = ((COSArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>) (TestProzeGen_get_removeFromFilteredListByObject.pdPage.getAnnotations(annotsFilter)));
        // remove object
