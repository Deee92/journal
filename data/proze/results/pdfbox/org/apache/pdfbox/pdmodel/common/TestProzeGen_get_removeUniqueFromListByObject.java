...
public class TestProzeGen_get_removeUniqueFromListByObject {
    ...
    public static void setUp() throws Exception {
        TestProzeGen_get_removeUniqueFromListByObject.annotationsList = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>();
        ...
        TestProzeGen_get_removeUniqueFromListByObject.annotationsList.add(txtMark);
        TestProzeGen_get_removeUniqueFromListByObject.annotationsList.add(txtLink);
        TestProzeGen_get_removeUniqueFromListByObject.annotationsList.add(aCircle);
        TestProzeGen_get_removeUniqueFromListByObject.annotationsList.add(txtLink);
        assertEquals(4, TestProzeGen_get_removeUniqueFromListByObject.annotationsList.size());
        TestProzeGen_get_removeUniqueFromListByObject.tbcAnnotationsList = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>();
        TestProzeGen_get_removeUniqueFromListByObject.tbcAnnotationsList.add(txtMark);
        TestProzeGen_get_removeUniqueFromListByObject.tbcAnnotationsList.add(txtLink);
        TestProzeGen_get_removeUniqueFromListByObject.tbcAnnotationsList.add(aCircle);
        TestProzeGen_get_removeUniqueFromListByObject.tbcAnnotationsList.add(txtLink);
        assertEquals(4, TestProzeGen_get_removeUniqueFromListByObject.tbcAnnotationsList.size());
        TestProzeGen_get_removeUniqueFromListByObject.annotationsArray = new org.apache.pdfbox.cos.COSArray();
        TestProzeGen_get_removeUniqueFromListByObject.annotationsArray.add(txtMark);
        TestProzeGen_get_removeUniqueFromListByObject.annotationsArray.add(txtLink);
        TestProzeGen_get_removeUniqueFromListByObject.annotationsArray.add(aCircle);
        TestProzeGen_get_removeUniqueFromListByObject.annotationsArray.add(txtLink);
        assertEquals(4, TestProzeGen_get_removeUniqueFromListByObject.annotationsArray.size());
        TestProzeGen_get_removeUniqueFromListByObject.tbcAnnotationsArray = new org.apache.pdfbox.cos.COSBase[4];
        TestProzeGen_get_removeUniqueFromListByObject.tbcAnnotationsArray[0] = txtMark.getCOSObject();
        TestProzeGen_get_removeUniqueFromListByObject.tbcAnnotationsArray[1] = txtLink.getCOSObject();
        TestProzeGen_get_removeUniqueFromListByObject.tbcAnnotationsArray[2] = aCircle.getCOSObject();
        TestProzeGen_get_removeUniqueFromListByObject.tbcAnnotationsArray[3] = txtLink.getCOSObject();
        assertEquals(4, TestProzeGen_get_removeUniqueFromListByObject.tbcAnnotationsArray.length);
        // add the annotations to the page
        TestProzeGen_get_removeUniqueFromListByObject.pdPage = new org.apache.pdfbox.pdmodel.PDPage();
        TestProzeGen_get_removeUniqueFromListByObject.pdPage.setAnnotations(TestProzeGen_get_removeUniqueFromListByObject.annotationsList);
        // create test output directory
        TestProzeGen_get_removeUniqueFromListByObject.OUT_DIR.mkdirs();
    }
    ...
    public void removeUniqueFromListByObject(int param0) throws Exception {
        COSArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation> cosArrayList = new COSArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>(TestProzeGen_get_removeUniqueFromListByObject.annotationsList, TestProzeGen_get_removeUniqueFromListByObject.annotationsArray);
        int positionToRemove = 2;
        org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation toBeRemoved = TestProzeGen_get_removeUniqueFromListByObject.annotationsList.get(positionToRemove);
        ...
        assertEquals(3, TestProzeGen_get_removeUniqueFromListByObject.annotationsArray.size(),
                "COSArray size shall be 3");
        // compare with Java List/Array to ensure correct object at position
        assertEquals(cosArrayList.get(param0), TestProzeGen_get_removeUniqueFromListByObject.tbcAnnotationsList.get(3),
                "List object at 3 is at position 2 in COSArrayList now");
        assertEquals(TestProzeGen_get_removeUniqueFromListByObject.annotationsArray.get(2), TestProzeGen_get_removeUniqueFromListByObject.tbcAnnotationsList.get(3).getCOSObject(),
                "COSObject of List object at 3 is at position 2 in COSArray now");
        assertEquals(TestProzeGen_get_removeUniqueFromListByObject.annotationsArray.get(2), TestProzeGen_get_removeUniqueFromListByObject.tbcAnnotationsArray[3],
                "Array object at 3 is at position 2 in underlying COSArray now");
        assertEquals(-1, cosArrayList.indexOf(TestProzeGen_get_removeUniqueFromListByObject.tbcAnnotationsList.get(positionToRemove)),
                "PDAnnotation shall no longer exist in List");
        assertEquals(-1, TestProzeGen_get_removeUniqueFromListByObject.annotationsArray.indexOf(TestProzeGen_get_removeUniqueFromListByObject.tbcAnnotationsArray[positionToRemove]),
