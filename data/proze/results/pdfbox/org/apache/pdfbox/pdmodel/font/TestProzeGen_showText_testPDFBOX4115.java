 ...
 */
public class TestProzeGen_showText_testPDFBOX4115 {
    private static final java.io.File OUT_DIR = new java.io.File("target/test-output");

    @BeforeAll
    public static void setUp() throws Exception {
        TestProzeGen_showText_testPDFBOX4115.OUT_DIR.mkdirs();
    }
    ...
    public void testPDFBOX4115(String param0) throws IOException {
        ...
        java.io.File outputFile = new java.io.File(TestProzeGen_showText_testPDFBOX4115.OUT_DIR, "FontType1.pdf");
        String text = "äöüÄÖÜ";
