...
public class TestProzeGen_get_removeIndirectObject {
    ...
    public static void setUp() throws Exception {
        TestProzeGen_get_removeIndirectObject.annotationsList = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>();
        ...
        TestProzeGen_get_removeIndirectObject.annotationsList.add(txtMark);
        TestProzeGen_get_removeIndirectObject.annotationsList.add(txtLink);
        TestProzeGen_get_removeIndirectObject.annotationsList.add(aCircle);
        TestProzeGen_get_removeIndirectObject.annotationsList.add(txtLink);
        assertEquals(4, TestProzeGen_get_removeIndirectObject.annotationsList.size());
        TestProzeGen_get_removeIndirectObject.tbcAnnotationsList = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>();
        TestProzeGen_get_removeIndirectObject.tbcAnnotationsList.add(txtMark);
        TestProzeGen_get_removeIndirectObject.tbcAnnotationsList.add(txtLink);
        TestProzeGen_get_removeIndirectObject.tbcAnnotationsList.add(aCircle);
        TestProzeGen_get_removeIndirectObject.tbcAnnotationsList.add(txtLink);
        assertEquals(4, TestProzeGen_get_removeIndirectObject.tbcAnnotationsList.size());
        TestProzeGen_get_removeIndirectObject.annotationsArray = new org.apache.pdfbox.cos.COSArray();
        TestProzeGen_get_removeIndirectObject.annotationsArray.add(txtMark);
        TestProzeGen_get_removeIndirectObject.annotationsArray.add(txtLink);
        TestProzeGen_get_removeIndirectObject.annotationsArray.add(aCircle);
        TestProzeGen_get_removeIndirectObject.annotationsArray.add(txtLink);
        assertEquals(4, TestProzeGen_get_removeIndirectObject.annotationsArray.size());
        TestProzeGen_get_removeIndirectObject.tbcAnnotationsArray = new org.apache.pdfbox.cos.COSBase[4];
        TestProzeGen_get_removeIndirectObject.tbcAnnotationsArray[0] = txtMark.getCOSObject();
        TestProzeGen_get_removeIndirectObject.tbcAnnotationsArray[1] = txtLink.getCOSObject();
        TestProzeGen_get_removeIndirectObject.tbcAnnotationsArray[2] = aCircle.getCOSObject();
        TestProzeGen_get_removeIndirectObject.tbcAnnotationsArray[3] = txtLink.getCOSObject();
        assertEquals(4, TestProzeGen_get_removeIndirectObject.tbcAnnotationsArray.length);
        // add the annotations to the page
        TestProzeGen_get_removeIndirectObject.pdPage = new org.apache.pdfbox.pdmodel.PDPage();
        TestProzeGen_get_removeIndirectObject.pdPage.setAnnotations(TestProzeGen_get_removeIndirectObject.annotationsList);
        // create test output directory
        TestProzeGen_get_removeIndirectObject.OUT_DIR.mkdirs();
    }
    ...
    public void removeIndirectObject(int param0) throws java.io.IOException {
        ...
        pdf.save(TestProzeGen_get_removeIndirectObject.OUT_DIR + "/removeIndirectObjectTest.pdf");
        pdf.close();
        pdf = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File(TestProzeGen_get_removeIndirectObject.OUT_DIR + "/removeIndirectObjectTest.pdf"));
        page = pdf.getPage(0);
