 ...
 */
public class TestProzeGen_PDPageContentStream_showText_java_lang_String_testDeleteFont {
    private static final java.io.File OUT_DIR = new java.io.File("target/test-output");

    @BeforeAll
    public static void setUp() throws Exception {
        TestProzeGen_PDPageContentStream_showText_java_lang_String_testDeleteFont.OUT_DIR.mkdirs();
    }
    ...
    public void testDeleteFont(String param0) throws IOException {
        java.io.File tempFontFile = new java.io.File(TestProzeGen_PDPageContentStream_showText_java_lang_String_testDeleteFont.OUT_DIR, "LiberationSans-Regular.ttf");
        java.io.File tempPdfFile = new java.io.File(TestProzeGen_PDPageContentStream_showText_java_lang_String_testDeleteFont.OUT_DIR, "testDeleteFont.pdf");
