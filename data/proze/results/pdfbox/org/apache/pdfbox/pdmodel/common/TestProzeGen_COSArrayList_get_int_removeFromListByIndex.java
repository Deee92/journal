...
public class TestProzeGen_COSArrayList_get_int_removeFromListByIndex {
    ...
    public static void setUp() throws Exception {
        TestProzeGen_COSArrayList_get_int_removeFromListByIndex.annotationsList = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>();
        ...
        TestProzeGen_COSArrayList_get_int_removeFromListByIndex.annotationsList.add(txtMark);
        TestProzeGen_COSArrayList_get_int_removeFromListByIndex.annotationsList.add(txtLink);
        TestProzeGen_COSArrayList_get_int_removeFromListByIndex.annotationsList.add(aCircle);
        TestProzeGen_COSArrayList_get_int_removeFromListByIndex.annotationsList.add(txtLink);
        assertEquals(4, TestProzeGen_COSArrayList_get_int_removeFromListByIndex.annotationsList.size());
        TestProzeGen_COSArrayList_get_int_removeFromListByIndex.tbcAnnotationsList = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>();
        TestProzeGen_COSArrayList_get_int_removeFromListByIndex.tbcAnnotationsList.add(txtMark);
        TestProzeGen_COSArrayList_get_int_removeFromListByIndex.tbcAnnotationsList.add(txtLink);
        TestProzeGen_COSArrayList_get_int_removeFromListByIndex.tbcAnnotationsList.add(aCircle);
        TestProzeGen_COSArrayList_get_int_removeFromListByIndex.tbcAnnotationsList.add(txtLink);
        assertEquals(4, TestProzeGen_COSArrayList_get_int_removeFromListByIndex.tbcAnnotationsList.size());
        TestProzeGen_COSArrayList_get_int_removeFromListByIndex.annotationsArray = new org.apache.pdfbox.cos.COSArray();
        TestProzeGen_COSArrayList_get_int_removeFromListByIndex.annotationsArray.add(txtMark);
        TestProzeGen_COSArrayList_get_int_removeFromListByIndex.annotationsArray.add(txtLink);
        TestProzeGen_COSArrayList_get_int_removeFromListByIndex.annotationsArray.add(aCircle);
        TestProzeGen_COSArrayList_get_int_removeFromListByIndex.annotationsArray.add(txtLink);
        assertEquals(4, TestProzeGen_COSArrayList_get_int_removeFromListByIndex.annotationsArray.size());
        TestProzeGen_COSArrayList_get_int_removeFromListByIndex.tbcAnnotationsArray = new org.apache.pdfbox.cos.COSBase[4];
        TestProzeGen_COSArrayList_get_int_removeFromListByIndex.tbcAnnotationsArray[0] = txtMark.getCOSObject();
        TestProzeGen_COSArrayList_get_int_removeFromListByIndex.tbcAnnotationsArray[1] = txtLink.getCOSObject();
        TestProzeGen_COSArrayList_get_int_removeFromListByIndex.tbcAnnotationsArray[2] = aCircle.getCOSObject();
        TestProzeGen_COSArrayList_get_int_removeFromListByIndex.tbcAnnotationsArray[3] = txtLink.getCOSObject();
        assertEquals(4, TestProzeGen_COSArrayList_get_int_removeFromListByIndex.tbcAnnotationsArray.length);
        // add the annotations to the page
        TestProzeGen_COSArrayList_get_int_removeFromListByIndex.pdPage = new org.apache.pdfbox.pdmodel.PDPage();
        TestProzeGen_COSArrayList_get_int_removeFromListByIndex.pdPage.setAnnotations(TestProzeGen_COSArrayList_get_int_removeFromListByIndex.annotationsList);
        // create test output directory
        TestProzeGen_COSArrayList_get_int_removeFromListByIndex.OUT_DIR.mkdirs();
    }
    ...
    public void removeFromListByIndex(int param0) throws Exception {
        COSArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation> cosArrayList = new COSArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>(TestProzeGen_COSArrayList_get_int_removeFromListByIndex.annotationsList, TestProzeGen_COSArrayList_get_int_removeFromListByIndex.annotationsArray);
        ...
        assertEquals(3, TestProzeGen_COSArrayList_get_int_removeFromListByIndex.annotationsArray.size(),
                "COSArray size shall be 3");
        assertEquals(-1, cosArrayList.indexOf(TestProzeGen_COSArrayList_get_int_removeFromListByIndex.tbcAnnotationsList.get(positionToRemove)),
                "PDAnnotation shall no longer exist in List");
        assertEquals(-1, TestProzeGen_COSArrayList_get_int_removeFromListByIndex.annotationsArray.indexOf(TestProzeGen_COSArrayList_get_int_removeFromListByIndex.tbcAnnotationsArray[positionToRemove]),
