...
public class TestProzeGen_save_removeSingleIndirectObject {
    ...
    public static void setUp() throws Exception {
        TestProzeGen_save_removeSingleIndirectObject.annotationsList = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>();
        ...
        TestProzeGen_save_removeSingleIndirectObject.annotationsList.add(txtMark);
        TestProzeGen_save_removeSingleIndirectObject.annotationsList.add(txtLink);
        TestProzeGen_save_removeSingleIndirectObject.annotationsList.add(aCircle);
        TestProzeGen_save_removeSingleIndirectObject.annotationsList.add(txtLink);
        assertEquals(4, TestProzeGen_save_removeSingleIndirectObject.annotationsList.size());
        TestProzeGen_save_removeSingleIndirectObject.tbcAnnotationsList = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>();
        TestProzeGen_save_removeSingleIndirectObject.tbcAnnotationsList.add(txtMark);
        TestProzeGen_save_removeSingleIndirectObject.tbcAnnotationsList.add(txtLink);
        TestProzeGen_save_removeSingleIndirectObject.tbcAnnotationsList.add(aCircle);
        TestProzeGen_save_removeSingleIndirectObject.tbcAnnotationsList.add(txtLink);
        assertEquals(4, TestProzeGen_save_removeSingleIndirectObject.tbcAnnotationsList.size());
        TestProzeGen_save_removeSingleIndirectObject.annotationsArray = new org.apache.pdfbox.cos.COSArray();
        TestProzeGen_save_removeSingleIndirectObject.annotationsArray.add(txtMark);
        TestProzeGen_save_removeSingleIndirectObject.annotationsArray.add(txtLink);
        TestProzeGen_save_removeSingleIndirectObject.annotationsArray.add(aCircle);
        TestProzeGen_save_removeSingleIndirectObject.annotationsArray.add(txtLink);
        assertEquals(4, TestProzeGen_save_removeSingleIndirectObject.annotationsArray.size());
        TestProzeGen_save_removeSingleIndirectObject.tbcAnnotationsArray = new org.apache.pdfbox.cos.COSBase[4];
        TestProzeGen_save_removeSingleIndirectObject.tbcAnnotationsArray[0] = txtMark.getCOSObject();
        TestProzeGen_save_removeSingleIndirectObject.tbcAnnotationsArray[1] = txtLink.getCOSObject();
        TestProzeGen_save_removeSingleIndirectObject.tbcAnnotationsArray[2] = aCircle.getCOSObject();
        TestProzeGen_save_removeSingleIndirectObject.tbcAnnotationsArray[3] = txtLink.getCOSObject();
        assertEquals(4, TestProzeGen_save_removeSingleIndirectObject.tbcAnnotationsArray.length);
        // add the annotations to the page
        TestProzeGen_save_removeSingleIndirectObject.pdPage = new org.apache.pdfbox.pdmodel.PDPage();
        TestProzeGen_save_removeSingleIndirectObject.pdPage.setAnnotations(TestProzeGen_save_removeSingleIndirectObject.annotationsList);
        // create test output directory
        TestProzeGen_save_removeSingleIndirectObject.OUT_DIR.mkdirs();
    }
    ...
    public void removeSingleIndirectObject(String param0) throws java.io.IOException {
        ...
        pdf.save(param0);
        pdf.close();
        pdf = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File(TestProzeGen_save_removeSingleIndirectObject.OUT_DIR + "/removeSingleIndirectObjectTest.pdf"));
        page = pdf.getPage(0);
