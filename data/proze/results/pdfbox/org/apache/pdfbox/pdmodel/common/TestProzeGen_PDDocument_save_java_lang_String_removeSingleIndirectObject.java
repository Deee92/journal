...
public class TestProzeGen_PDDocument_save_java_lang_String_removeSingleIndirectObject {
    ...
    public static void setUp() throws Exception {
        TestProzeGen_PDDocument_save_java_lang_String_removeSingleIndirectObject.annotationsList = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>();
        ...
        TestProzeGen_PDDocument_save_java_lang_String_removeSingleIndirectObject.annotationsList.add(txtMark);
        TestProzeGen_PDDocument_save_java_lang_String_removeSingleIndirectObject.annotationsList.add(txtLink);
        TestProzeGen_PDDocument_save_java_lang_String_removeSingleIndirectObject.annotationsList.add(aCircle);
        TestProzeGen_PDDocument_save_java_lang_String_removeSingleIndirectObject.annotationsList.add(txtLink);
        assertEquals(4, TestProzeGen_PDDocument_save_java_lang_String_removeSingleIndirectObject.annotationsList.size());
        TestProzeGen_PDDocument_save_java_lang_String_removeSingleIndirectObject.tbcAnnotationsList = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>();
        TestProzeGen_PDDocument_save_java_lang_String_removeSingleIndirectObject.tbcAnnotationsList.add(txtMark);
        TestProzeGen_PDDocument_save_java_lang_String_removeSingleIndirectObject.tbcAnnotationsList.add(txtLink);
        TestProzeGen_PDDocument_save_java_lang_String_removeSingleIndirectObject.tbcAnnotationsList.add(aCircle);
        TestProzeGen_PDDocument_save_java_lang_String_removeSingleIndirectObject.tbcAnnotationsList.add(txtLink);
        assertEquals(4, TestProzeGen_PDDocument_save_java_lang_String_removeSingleIndirectObject.tbcAnnotationsList.size());
        TestProzeGen_PDDocument_save_java_lang_String_removeSingleIndirectObject.annotationsArray = new org.apache.pdfbox.cos.COSArray();
        TestProzeGen_PDDocument_save_java_lang_String_removeSingleIndirectObject.annotationsArray.add(txtMark);
        TestProzeGen_PDDocument_save_java_lang_String_removeSingleIndirectObject.annotationsArray.add(txtLink);
        TestProzeGen_PDDocument_save_java_lang_String_removeSingleIndirectObject.annotationsArray.add(aCircle);
        TestProzeGen_PDDocument_save_java_lang_String_removeSingleIndirectObject.annotationsArray.add(txtLink);
        assertEquals(4, TestProzeGen_PDDocument_save_java_lang_String_removeSingleIndirectObject.annotationsArray.size());
        TestProzeGen_PDDocument_save_java_lang_String_removeSingleIndirectObject.tbcAnnotationsArray = new org.apache.pdfbox.cos.COSBase[4];
        TestProzeGen_PDDocument_save_java_lang_String_removeSingleIndirectObject.tbcAnnotationsArray[0] = txtMark.getCOSObject();
        TestProzeGen_PDDocument_save_java_lang_String_removeSingleIndirectObject.tbcAnnotationsArray[1] = txtLink.getCOSObject();
        TestProzeGen_PDDocument_save_java_lang_String_removeSingleIndirectObject.tbcAnnotationsArray[2] = aCircle.getCOSObject();
        TestProzeGen_PDDocument_save_java_lang_String_removeSingleIndirectObject.tbcAnnotationsArray[3] = txtLink.getCOSObject();
        assertEquals(4, TestProzeGen_PDDocument_save_java_lang_String_removeSingleIndirectObject.tbcAnnotationsArray.length);
        // add the annotations to the page
        TestProzeGen_PDDocument_save_java_lang_String_removeSingleIndirectObject.pdPage = new org.apache.pdfbox.pdmodel.PDPage();
        TestProzeGen_PDDocument_save_java_lang_String_removeSingleIndirectObject.pdPage.setAnnotations(TestProzeGen_PDDocument_save_java_lang_String_removeSingleIndirectObject.annotationsList);
        // create test output directory
        TestProzeGen_PDDocument_save_java_lang_String_removeSingleIndirectObject.OUT_DIR.mkdirs();
    }
    ...
    public void removeSingleIndirectObject(String param0) throws java.io.IOException {
        ...
        pdf.save(param0);
        pdf.close();
        pdf = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File(TestProzeGen_PDDocument_save_java_lang_String_removeSingleIndirectObject.OUT_DIR + "/removeSingleIndirectObjectTest.pdf"));
        page = pdf.getPage(0);
