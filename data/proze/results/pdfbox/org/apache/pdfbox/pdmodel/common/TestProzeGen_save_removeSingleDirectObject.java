...
public class TestProzeGen_save_removeSingleDirectObject {
    ...
    public static void setUp() throws Exception {
        TestProzeGen_save_removeSingleDirectObject.annotationsList = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>();
        ...
        TestProzeGen_save_removeSingleDirectObject.annotationsList.add(txtMark);
        TestProzeGen_save_removeSingleDirectObject.annotationsList.add(txtLink);
        TestProzeGen_save_removeSingleDirectObject.annotationsList.add(aCircle);
        TestProzeGen_save_removeSingleDirectObject.annotationsList.add(txtLink);
        assertEquals(4, TestProzeGen_save_removeSingleDirectObject.annotationsList.size());
        TestProzeGen_save_removeSingleDirectObject.tbcAnnotationsList = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>();
        TestProzeGen_save_removeSingleDirectObject.tbcAnnotationsList.add(txtMark);
        TestProzeGen_save_removeSingleDirectObject.tbcAnnotationsList.add(txtLink);
        TestProzeGen_save_removeSingleDirectObject.tbcAnnotationsList.add(aCircle);
        TestProzeGen_save_removeSingleDirectObject.tbcAnnotationsList.add(txtLink);
        assertEquals(4, TestProzeGen_save_removeSingleDirectObject.tbcAnnotationsList.size());
        TestProzeGen_save_removeSingleDirectObject.annotationsArray = new org.apache.pdfbox.cos.COSArray();
        TestProzeGen_save_removeSingleDirectObject.annotationsArray.add(txtMark);
        TestProzeGen_save_removeSingleDirectObject.annotationsArray.add(txtLink);
        TestProzeGen_save_removeSingleDirectObject.annotationsArray.add(aCircle);
        TestProzeGen_save_removeSingleDirectObject.annotationsArray.add(txtLink);
        assertEquals(4, TestProzeGen_save_removeSingleDirectObject.annotationsArray.size());
        TestProzeGen_save_removeSingleDirectObject.tbcAnnotationsArray = new org.apache.pdfbox.cos.COSBase[4];
        TestProzeGen_save_removeSingleDirectObject.tbcAnnotationsArray[0] = txtMark.getCOSObject();
        TestProzeGen_save_removeSingleDirectObject.tbcAnnotationsArray[1] = txtLink.getCOSObject();
        TestProzeGen_save_removeSingleDirectObject.tbcAnnotationsArray[2] = aCircle.getCOSObject();
        TestProzeGen_save_removeSingleDirectObject.tbcAnnotationsArray[3] = txtLink.getCOSObject();
        assertEquals(4, TestProzeGen_save_removeSingleDirectObject.tbcAnnotationsArray.length);
        // add the annotations to the page
        TestProzeGen_save_removeSingleDirectObject.pdPage = new org.apache.pdfbox.pdmodel.PDPage();
        TestProzeGen_save_removeSingleDirectObject.pdPage.setAnnotations(TestProzeGen_save_removeSingleDirectObject.annotationsList);
        // create test output directory
        TestProzeGen_save_removeSingleDirectObject.OUT_DIR.mkdirs();
    }
    ...
    public void removeSingleDirectObject(String param0) throws java.io.IOException {
        ...
        pdf.save(param0);
        pdf.close();
        pdf = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File(TestProzeGen_save_removeSingleDirectObject.OUT_DIR + "/removeSingleDirectObjectTest.pdf"));
        page = pdf.getPage(0);
