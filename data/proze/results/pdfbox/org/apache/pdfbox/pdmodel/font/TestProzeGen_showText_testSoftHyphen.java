 ...
 */
public class TestProzeGen_showText_testSoftHyphen {
    private static final java.io.File OUT_DIR = new java.io.File("target/test-output");

    @BeforeAll
    public static void setUp() throws Exception {
        TestProzeGen_showText_testSoftHyphen.OUT_DIR.mkdirs();
    }
    ...
    public void testSoftHyphen(String param0) throws java.io.IOException {
        ...
        PDFont font2 = PDType0Font.load(doc, TestProzeGen_showText_testSoftHyphen.class.getResourceAsStream("/org/apache/pdfbox/resources/ttf/LiberationSans-Regular.ttf"));
