...
public class TestProzeGen_get_removeFromListByIndex {
    ...
    public static void setUp() throws Exception {
        TestProzeGen_get_removeFromListByIndex.annotationsList = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>();
        ...
        TestProzeGen_get_removeFromListByIndex.annotationsList.add(txtMark);
        TestProzeGen_get_removeFromListByIndex.annotationsList.add(txtLink);
        TestProzeGen_get_removeFromListByIndex.annotationsList.add(aCircle);
        TestProzeGen_get_removeFromListByIndex.annotationsList.add(txtLink);
        assertEquals(4, TestProzeGen_get_removeFromListByIndex.annotationsList.size());
        TestProzeGen_get_removeFromListByIndex.tbcAnnotationsList = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>();
        TestProzeGen_get_removeFromListByIndex.tbcAnnotationsList.add(txtMark);
        TestProzeGen_get_removeFromListByIndex.tbcAnnotationsList.add(txtLink);
        TestProzeGen_get_removeFromListByIndex.tbcAnnotationsList.add(aCircle);
        TestProzeGen_get_removeFromListByIndex.tbcAnnotationsList.add(txtLink);
        assertEquals(4, TestProzeGen_get_removeFromListByIndex.tbcAnnotationsList.size());
        TestProzeGen_get_removeFromListByIndex.annotationsArray = new org.apache.pdfbox.cos.COSArray();
        TestProzeGen_get_removeFromListByIndex.annotationsArray.add(txtMark);
        TestProzeGen_get_removeFromListByIndex.annotationsArray.add(txtLink);
        TestProzeGen_get_removeFromListByIndex.annotationsArray.add(aCircle);
        TestProzeGen_get_removeFromListByIndex.annotationsArray.add(txtLink);
        assertEquals(4, TestProzeGen_get_removeFromListByIndex.annotationsArray.size());
        TestProzeGen_get_removeFromListByIndex.tbcAnnotationsArray = new org.apache.pdfbox.cos.COSBase[4];
        TestProzeGen_get_removeFromListByIndex.tbcAnnotationsArray[0] = txtMark.getCOSObject();
        TestProzeGen_get_removeFromListByIndex.tbcAnnotationsArray[1] = txtLink.getCOSObject();
        TestProzeGen_get_removeFromListByIndex.tbcAnnotationsArray[2] = aCircle.getCOSObject();
        TestProzeGen_get_removeFromListByIndex.tbcAnnotationsArray[3] = txtLink.getCOSObject();
        assertEquals(4, TestProzeGen_get_removeFromListByIndex.tbcAnnotationsArray.length);
        // add the annotations to the page
        TestProzeGen_get_removeFromListByIndex.pdPage = new org.apache.pdfbox.pdmodel.PDPage();
        TestProzeGen_get_removeFromListByIndex.pdPage.setAnnotations(TestProzeGen_get_removeFromListByIndex.annotationsList);
        // create test output directory
        TestProzeGen_get_removeFromListByIndex.OUT_DIR.mkdirs();
    }
    ...
    public void removeFromListByIndex(int param0) throws Exception {
        COSArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation> cosArrayList = new COSArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>(TestProzeGen_get_removeFromListByIndex.annotationsList, TestProzeGen_get_removeFromListByIndex.annotationsArray);
        ...
        assertEquals(3, TestProzeGen_get_removeFromListByIndex.annotationsArray.size(),
                "COSArray size shall be 3");
        assertEquals(-1, cosArrayList.indexOf(TestProzeGen_get_removeFromListByIndex.tbcAnnotationsList.get(positionToRemove)),
                "PDAnnotation shall no longer exist in List");
        assertEquals(-1, TestProzeGen_get_removeFromListByIndex.annotationsArray.indexOf(TestProzeGen_get_removeFromListByIndex.tbcAnnotationsArray[positionToRemove]),
