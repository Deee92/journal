...
public class TestProzeGen_save_removeIndirectObject {
    ...
    public static void setUp() throws Exception {
        TestProzeGen_save_removeIndirectObject.annotationsList = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>();
        ...
        TestProzeGen_save_removeIndirectObject.annotationsList.add(txtMark);
        TestProzeGen_save_removeIndirectObject.annotationsList.add(txtLink);
        TestProzeGen_save_removeIndirectObject.annotationsList.add(aCircle);
        TestProzeGen_save_removeIndirectObject.annotationsList.add(txtLink);
        assertEquals(4, TestProzeGen_save_removeIndirectObject.annotationsList.size());
        TestProzeGen_save_removeIndirectObject.tbcAnnotationsList = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>();
        TestProzeGen_save_removeIndirectObject.tbcAnnotationsList.add(txtMark);
        TestProzeGen_save_removeIndirectObject.tbcAnnotationsList.add(txtLink);
        TestProzeGen_save_removeIndirectObject.tbcAnnotationsList.add(aCircle);
        TestProzeGen_save_removeIndirectObject.tbcAnnotationsList.add(txtLink);
        assertEquals(4, TestProzeGen_save_removeIndirectObject.tbcAnnotationsList.size());
        TestProzeGen_save_removeIndirectObject.annotationsArray = new org.apache.pdfbox.cos.COSArray();
        TestProzeGen_save_removeIndirectObject.annotationsArray.add(txtMark);
        TestProzeGen_save_removeIndirectObject.annotationsArray.add(txtLink);
        TestProzeGen_save_removeIndirectObject.annotationsArray.add(aCircle);
        TestProzeGen_save_removeIndirectObject.annotationsArray.add(txtLink);
        assertEquals(4, TestProzeGen_save_removeIndirectObject.annotationsArray.size());
        TestProzeGen_save_removeIndirectObject.tbcAnnotationsArray = new org.apache.pdfbox.cos.COSBase[4];
        TestProzeGen_save_removeIndirectObject.tbcAnnotationsArray[0] = txtMark.getCOSObject();
        TestProzeGen_save_removeIndirectObject.tbcAnnotationsArray[1] = txtLink.getCOSObject();
        TestProzeGen_save_removeIndirectObject.tbcAnnotationsArray[2] = aCircle.getCOSObject();
        TestProzeGen_save_removeIndirectObject.tbcAnnotationsArray[3] = txtLink.getCOSObject();
        assertEquals(4, TestProzeGen_save_removeIndirectObject.tbcAnnotationsArray.length);
        // add the annotations to the page
        TestProzeGen_save_removeIndirectObject.pdPage = new org.apache.pdfbox.pdmodel.PDPage();
        TestProzeGen_save_removeIndirectObject.pdPage.setAnnotations(TestProzeGen_save_removeIndirectObject.annotationsList);
        // create test output directory
        TestProzeGen_save_removeIndirectObject.OUT_DIR.mkdirs();
    }
    ...
    public void removeIndirectObject(String param0) throws java.io.IOException {
        ...
        pdf.save(param0);
        pdf.close();
        pdf = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File(TestProzeGen_save_removeIndirectObject.OUT_DIR + "/removeIndirectObjectTest.pdf"));
        page = pdf.getPage(0);
