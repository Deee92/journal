...
----> before:         return new PDTrueTypeFont(doc, new TTFParser().parse(file), encoding, true);
----> after:         return new PDTrueTypeFont(doc, null.parse(file), encoding, true);
...
public class PDTrueTypeFont extends PDSimpleFont implements PDVectorFont
{
    ...
    public static PDTrueTypeFont load(PDDocument doc, File file, Encoding encoding)
            throws IOException
    {
        return new PDTrueTypeFont(doc, null.parse(file), encoding, true);
    }
