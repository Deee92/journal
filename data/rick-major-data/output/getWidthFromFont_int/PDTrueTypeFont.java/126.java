...
----> before:         return new PDTrueTypeFont(doc, new TTFParser().parse(file), WinAnsiEncoding.INSTANCE, true);
----> after:         return new PDTrueTypeFont(doc, null.parse(file), WinAnsiEncoding.INSTANCE, true);
...
public class PDTrueTypeFont extends PDSimpleFont implements PDVectorFont
{
    ...
    {
        return new PDTrueTypeFont(doc, null.parse(file), WinAnsiEncoding.INSTANCE, true);
    }
