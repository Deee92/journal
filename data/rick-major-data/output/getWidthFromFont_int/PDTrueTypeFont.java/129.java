...
----> before:         return new PDTrueTypeFont(doc, new TTFParser().parse(input), encoding, true);
----> after:         return new PDTrueTypeFont(doc, null.parse(input), encoding, true);
...
public class PDTrueTypeFont extends PDSimpleFont implements PDVectorFont
{
    ...
    public static PDTrueTypeFont load(PDDocument doc, InputStream input, Encoding encoding)
            throws IOException
    {
        return new PDTrueTypeFont(doc, null.parse(input), encoding, true);
    }
