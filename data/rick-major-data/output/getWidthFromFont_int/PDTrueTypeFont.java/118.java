...
----> before:         PDTrueTypeFontEmbedder embedder = new PDTrueTypeFontEmbedder(document, dict, ttf,
----> after:         PDTrueTypeFontEmbedder embedder = null;
...
public class PDTrueTypeFont extends PDSimpleFont implements PDVectorFont
{
    ...
    private PDTrueTypeFont(PDDocument document, TrueTypeFont ttf, Encoding encoding,
            ...
            throws IOException
    {
        PDTrueTypeFontEmbedder embedder = null;
