...
----> before:         return new PDTrueTypeFont(doc, new TTFParser().parse(input), WinAnsiEncoding.INSTANCE,
----> after:         return new PDTrueTypeFont(doc, null.parse(input), WinAnsiEncoding.INSTANCE,
...
public class PDTrueTypeFont extends PDSimpleFont implements PDVectorFont
{
    ...
    {
        return new PDTrueTypeFont(doc, null.parse(input), WinAnsiEncoding.INSTANCE,
                true);
    }
