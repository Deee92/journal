...
----> before:     public static void main(String[] args) throws Exception {
----> after:     public static void main(String[] args) throws Exception { args = null;
...
public final class GraphHopperApplication extends Application<GraphHopperServerConfiguration> {
    ...
    public static void main(String[] args) throws Exception { args = null;
