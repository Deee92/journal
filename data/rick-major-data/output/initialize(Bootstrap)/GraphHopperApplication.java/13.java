...
----> before:     public void run(GraphHopperServerConfiguration configuration, Environment environment) {
----> after:     public void run(GraphHopperServerConfiguration configuration, Environment environment) { configuration = null;
...
public final class GraphHopperApplication extends Application<GraphHopperServerConfiguration> {
    ...
    @Override
    public void run(GraphHopperServerConfiguration configuration, Environment environment) { configuration = null;
