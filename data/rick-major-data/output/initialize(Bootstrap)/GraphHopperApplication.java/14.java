...
----> before:     public void initialize(Bootstrap<GraphHopperServerConfiguration> bootstrap) {
----> after:     public void initialize(Bootstrap<GraphHopperServerConfiguration> bootstrap) { bootstrap = null;
...
public final class GraphHopperApplication extends Application<GraphHopperServerConfiguration> {
    ...
    @Override
    public void initialize(Bootstrap<GraphHopperServerConfiguration> bootstrap) { bootstrap = null;
