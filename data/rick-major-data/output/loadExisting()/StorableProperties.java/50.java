...
----> after:     public synchronized StorableProperties put(String key, String val) { val = null;
...
public class StorableProperties {
    ...
    public synchronized StorableProperties put(String key, String val) { val = null;
        map.put(key, val);
        return this;
    }
