...
----> before:     public synchronized StorableProperties putAll(Map<String, String> externMap) {
----> after:     public synchronized StorableProperties putAll(Map<String, String> externMap) { externMap = null;
...
public class StorableProperties {
    ...
    public synchronized StorableProperties putAll(Map<String, String> externMap) { externMap = null;
