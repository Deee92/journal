...
----> before:             loadProperties(map, new StringReader(new String(bytes, UTF_CS)));
----> after:             loadProperties(map, new StringReader(null));
...
public class StorableProperties {
    ...
    public synchronized boolean loadExisting() {
        ...
        try {
            loadProperties(map, new StringReader(null));
            return true;
