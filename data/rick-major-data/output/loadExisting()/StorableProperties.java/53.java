...
----> before:     public synchronized StorableProperties remove(String key) {
----> after:     public synchronized StorableProperties remove(String key) { key = null;
...
public class StorableProperties {
    ...
    public synchronized StorableProperties remove(String key) { key = null;
        map.remove(key);
        return this;
    }
