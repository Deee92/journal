...
----> before:     public synchronized StorableProperties put(String key, String val) {
----> after:     public synchronized StorableProperties put(String key, String val) { key = null;
...
public class StorableProperties {
    ...
    public synchronized StorableProperties put(String key, String val) { key = null;
        map.put(key, val);
        return this;
    }
