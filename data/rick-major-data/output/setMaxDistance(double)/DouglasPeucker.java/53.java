...
----> after:     public int simplify(PointList points, int fromIndex, int lastIndex) { points = null;
...
public class DouglasPeucker {
    ...
    public int simplify(PointList points, int fromIndex, int lastIndex) { points = null;
