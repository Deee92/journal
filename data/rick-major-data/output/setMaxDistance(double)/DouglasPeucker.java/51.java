...
----> after:     int subSimplify(PointList points, int fromIndex, int lastIndex) { points = null;
...
public class DouglasPeucker {
    ...
    int subSimplify(PointList points, int fromIndex, int lastIndex) { points = null;
