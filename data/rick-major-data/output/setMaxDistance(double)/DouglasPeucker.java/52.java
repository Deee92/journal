...
----> after:     public int simplify(PointList points, int fromIndex, int lastIndex, boolean compress) { points = null;
...
public class DouglasPeucker {
     ...
     */
    public int simplify(PointList points, int fromIndex, int lastIndex, boolean compress) { points = null;
        int removed = 0;
