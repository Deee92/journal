...
public class TestPDPageContentStreamPanktiGen {
    ...
    public void test_setFont_PO_dcf69593d8b9474fa8c132cc1dab21c1() throws Exception {
        ...
        File fileReceiving = new File(classLoader.getResource("org.apache.pdfbox.pdmodel.PDPageContentStream.setFont1-receiving.xml").getFile());
        org.apache.pdfbox.pdmodel.PDPageContentStream receivingObject = deserializeObject(fileReceiving);
        File fileParams = new File(classLoader.getResource("org.apache.pdfbox.pdmodel.PDPageContentStream.setFont1-params.xml").getFile());
    ...
    public void test_setFont_CO_dcf69593d8b9474fa8c132cc1dab21c1() throws Exception {
        ...
        orderVerifier.verify(mockPDFont).willBeSubset();
    }
}